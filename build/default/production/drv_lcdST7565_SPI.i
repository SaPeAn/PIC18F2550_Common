...
void LCD_Init(void)
{
  ...
  PORTAbits.RA4 = 1;
  PORTAbits.RA3 = 0;
  LCD_WriteByte(0xA2 | 0);
  LCD_WriteByte(0xA0 | 0);
  LCD_WriteByte(0xC0 | 8);
  LCD_WriteByte(0x20 | 0x5);
  LCD_WriteByte(0x28 | 0b111);

  LCD_WriteByte(0x81);
  LCD_WriteByte(0x20);
  LCD_WriteByte(0x40 | 0);
  LCD_WriteByte(0xB0 | 0);
  LCD_WriteByte(0x10 | 0);
  LCD_WriteByte(0x00 | 0);
  LCD_WriteByte(0xAE | 1);
  LCD_WriteByte(0xA6 | 0);
  PORTAbits.RA3 = 1;
}
